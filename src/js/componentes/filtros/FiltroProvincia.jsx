...
export class FiltroProvincia extends React.Component {
    ...
    render(){
        //
        let arrayOptions = this.state.provNombres.map((item,idx) => (
